    ...
    if (isset($_GET['id'])) {
        try {
            ...
            if ($user_id) {
                ...
                // Se l'utente che sto cercando di cancellare è l'utente corrente blocco la richiesta
                if ($user_id != $_GET['id']) {
                    ...
                    echo json_encode([
                        "success" => false,
                        "message" => "Impossibile eliminare l'utente corrente"
                    ]);
                }
